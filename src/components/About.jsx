...
const STATS = [
  { n: '9.09', l: 'CGPA' },
  { n: '2+', l: 'Articles Written' },
  { n: '2', l: 'Hackathons Participated' },
    ...
    <section id="about" ref={ref}>
      <div className="container">
        ...
        <div className="about-grid">
          <div>
            ...
            <div className="about-text reveal reveal-delay-2">
              <p>
                I'm a <strong>Pre-Final year Pharmaceutical Technology student</strong> at
        ...
        <div className="about-pub reveal reveal-delay-2">
          ...
          <div className="pub-venue">
            Verve 31th Edition &mdash; Biotechcellence&apos;26 &middot; Anna University, Chennai
          </div>
        </div>
      </div>
    </section>
